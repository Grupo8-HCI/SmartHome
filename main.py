...
def main():
    ...
    skill_builder.add_request_handler(TurnOnWhiteLedIntent())
    skill_builder.add_request_handler(TurnOffWhiteLedIntent())
    skill_builder.add_request_handler(TurnOnYellowLedIntent())
    skill_builder.add_request_handler(TurnOffYellowLedIntent())
    skill_builder.add_request_handler(TurnOnLedsIntent())
    skill_builder.add_request_handler(TurnOffLedsIntent())
    skill_builder.add_request_handler(OpenDoorIntent())
    skill_builder.add_request_handler(CloseDoorIntent())
